...
<section class="card">
    ...
    <p>Danh sách sản phẩm đang hiển thị theo thời gian tạo mới nhất.</p>
    <div class="product-grid">
        ...
        <c:if test="${empty products}">
            <p>Chưa có sản phẩm hiển thị. Vui lòng thêm sản phẩm trong trang quản trị.</p>
        </c:if>
    </div>
    <p><a href="<c:url value='/product'/>">Xem tất cả sản phẩm</a></p>
</section>
