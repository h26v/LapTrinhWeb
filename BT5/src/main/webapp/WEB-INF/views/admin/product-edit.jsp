...
<section class="card border-0 mx-auto" style="max-width: 720px;">
    <div class="card-body p-4">
        <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap mb-3">
            <h1 class="h3 mb-0">Sửa sản phẩm #<c:out value="${product.productId}"/></h1>
        ...
        <form action="<c:url value='/admin/product/update'/>" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="number" step="0.01" min="0" id="price" name="price" required
                           value="<c:out value='${empty priceInput ? product.price : priceInput}'/>"/>
                </div>
                <div class="col-md-6">
            ...
            <div class="mb-3 mt-3">
                ...
                <c:choose>
                    ...
                    <c:when test="${fn:startsWith(product.images, 'https://') || fn:startsWith(product.images, 'http://')}">
                        <img class="icon" src="<c:out value='${product.images}'/>" alt="Ảnh sản phẩm"/>
                    </c:when>
                    <c:otherwise>
            ...
            <div class="mb-3">
                <label class="form-label" for="images">Đổi ảnh khác</label>
